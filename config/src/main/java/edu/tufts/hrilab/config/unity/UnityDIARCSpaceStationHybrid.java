...
public class UnityDIARCSpaceStationHybrid {
  ...
  public static void main(String[] args) {
    ...
    DiarcComponent.createInstance(edu.tufts.hrilab.slug.parsing.hybrid.HybridParserComponent.class, "-tldl pr2Unity.dict  -tldlNoUpdateAddressee"); //-llm spaceStationLLMParser -cacheName unity_space_station -cachePersist false -noConfirmation
