...
public class HeadTrajControllerPointHeadAction {
  ...
  private Publisher<pr2_controllers_msgs.JointTrajectoryControllerState> HeadTrajControllerStatePublisher;
  ...
  private SimpleActionClient<
          ...
          pr2_controllers_msgs.PointHeadResult> client;

  public HeadTrajControllerPointHeadAction() {
    nodeMain = new AbstractNodeMain() {
      @Override
      public GraphName getDefaultNodeName() {
        return GraphName.of("ade/head_traj_controller/point_head_action");
      }
      ...
      public void onStart(ConnectedNode connectedNode) {
        node = connectedNode;
        // Subscribers
        Subscriber<trajectory_msgs.JointTrajectory> HeadTrajControllerCommandSub = node.newSubscriber("/head_traj_controller/command", trajectory_msgs.JointTrajectory._TYPE);
        ...
        HeadTrajControllerStatePublisher = node.newPublisher("/head_traj_controller/state", pr2_controllers_msgs.JointTrajectoryControllerState._TYPE);
        ...
        //Services
        try {
          HeadTrajControllerPointHeadActionSetLoggerLevel = node.newServiceClient("/head_traj_controller/point_head_action/set_logger_level", roscpp.SetLoggerLevel._TYPE);
        } catch (org.ros.exception.ServiceNotFoundException e) {
          System.err.println("Could not find service! Exception: " + e);
        }
        try {
          HeadTrajControllerPointHeadActionGetLoggers = node.newServiceClient("/head_traj_controller/point_head_action/get_loggers", roscpp.GetLoggers._TYPE);
        } catch (org.ros.exception.ServiceNotFoundException e) {
          System.err.println("Could not find service! Exception: " + e);
        }
        // Action Client
        try {
          client = new SimpleActionClient<>("/head_traj_controller/point_head_action",
                  new ActionSpec(pr2_controllers_msgs.PointHeadAction.class,
  ...
  public void sendHeadTrajControllerState(edu.tufts.hrilab.diarcros.msg.pr2_controllers_msgs.JointTrajectoryControllerState msg) {
    HeadTrajControllerStatePublisher.publish(edu.tufts.hrilab.diarcros.msg.pr2_controllers_msgs.JointTrajectoryControllerState.toRos(msg, node));
  }
  ...
  public pr2_controllers_msgs.PointHeadResult getResult() throws RosException {
  ...
  public void sendGoal(edu.tufts.hrilab.diarcros.msg.pr2_controllers_msgs.PointHeadGoal goal) throws RosException {
    client.sendGoal(edu.tufts.hrilab.diarcros.msg.pr2_controllers_msgs.PointHeadGoal.toRos(goal, node));
  }
