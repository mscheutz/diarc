...
() = init["simulates environmental setup"]() {
   ...
   !servingArea = !yumiL.act:addArea("\"serving area\"", !tableOneRef); //both arms
   ...
   !prepArea = !yumiL.act:addArea("\"prep area\"", !tableOneRef); //right and human
   ...
   !hotplateArea = !yumiL.act:addArea("\"hot plate\"", !tableOneRef); //right
